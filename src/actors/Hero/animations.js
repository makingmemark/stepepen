...
const walk2 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [12], 200);
const walk3 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [14], 200);

const walkR1 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [10], 200);
walkR1.flipHorizontal = true;
const walkR2 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [12], 200);
walkR2.flipHorizontal = true;
const walkR3 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [14], 200);
walkR3.flipHorizontal = true;

const walkS1 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [10], 200);
const walkS2 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [12], 200);
const walkS3 = ex.Animation.fromSpriteSheet(heroSpriteSheet, [14], 200);
